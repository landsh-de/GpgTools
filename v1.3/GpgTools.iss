...
#define MyAppVer "1.3.4.0"
#define MyAppVerName "GpgTools 1.3.4.0"
...
Source: data\Program Files (x86)\GpgTools\StartCon\GpgOL_Enabe_OLK2016_Resiliency.exe; DestDir: {app}\StartCon; Flags: ignoreversion uninsrestartdelete overwritereadonly; Components: confpatchtoolpol conftoolpol confpatchtool conftool
Source: data\Program Files (x86)\GpgTools\StartCon\GpgOL_Enabe_OLK2016_Resiliency.ini; DestDir: {app}\StartCon; Flags: ignoreversion uninsrestartdelete overwritereadonly; Components: confpatchtoolpol conftoolpol confpatchtool conftool
Source: data\Program Files (x86)\GpgTools\StartCon\GpgOL_Config_InlinePGP.exe; DestDir: {app}\StartCon; Flags: ignoreversion uninsrestartdelete overwritereadonly; Components: confpatchtoolpol conftoolpol confpatchtool conftool
Source: data\Program Files (x86)\GpgTools\StartCon\GpgOL_Config_InlinePGP.ini; DestDir: {app}\StartCon; Flags: ignoreversion uninsrestartdelete overwritereadonly; Components: confpatchtoolpol conftoolpol confpatchtool conftool
Source: data\Program Files (x86)\GpgTools\StartCon\GpgOL_Set_OLK_LoadBehavior.exe; DestDir: {app}\StartCon; Flags: ignoreversion uninsrestartdelete overwritereadonly; Components: confpatchtoolpol conftoolpol confpatchtool conftool
Source: data\Program Files (x86)\GpgTools\StartCon\GpgOL_Set_OLK_LoadBehavior.ini; DestDir: {app}\StartCon; Flags: ignoreversion uninsrestartdelete overwritereadonly; Components: confpatchtoolpol conftoolpol confpatchtool conftool
...
Root: "HKLM"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: expandsz; ValueName: "Gpg4Win_Cleanup"; ValueData: """{app}\StartCon\Gpg4Win_beenden.exe"""; Flags: uninsdeletevalue; Components: confpatchtoolpol conftoolpol confpatchtool conftool
...
; AutoRun Init GpgOL_Enabe_OLK2016_Resiliency
Root: "HKLM"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: expandsz; ValueName: "GpgOL_Enabe_OLK2016_Resiliency"; ValueData: """{app}\StartCon\GpgOL_Enabe_OLK2016_Resiliency.exe"""; Flags: uninsdeletevalue; Components: confpatchtoolpol conftoolpol confpatchtool conftool
; AutoRun Init GpgOL_Set_OLK_LoadBehavior
Root: "HKLM"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: expandsz; ValueName: "GpgOL_Set_OLK_LoadBehavior"; ValueData: """{app}\StartCon\GpgOL_Set_OLK_LoadBehavior.exe"""; Flags: uninsdeletevalue; Components: confpatchtoolpol conftoolpol confpatchtool conftool
; AutoRun Init GpgOL_Config_InlinePGP
Root: "HKLM"; Subkey: "Software\Microsoft\Windows\CurrentVersion\Run"; ValueType: expandsz; ValueName: "GpgOL_Config_InlinePGP"; ValueData: """{app}\StartCon\GpgOL_Config_InlinePGP.exe"""; Flags: uninsdeletevalue; Components: confpatchtoolpol conftoolpol confpatchtool conftool
...
; Policy Execution Enabler GpgTools -GpgOL_Enabe_OLK2016_Resiliency-
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{54CECC54-313E-469c-A257-4FA25A37C16A}"; ValueType: string; ValueName: "Description"; ValueData: "GpgOL_Enabe_OLK2016_Resiliency ..."; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{54CECC54-313E-469c-A257-4FA25A37C16A}"; ValueType: string; ValueName: "ItemData"; ValueData: "{app}\StartCon\GpgOL_Enabe_OLK2016_Resiliency.exe"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{54CECC54-313E-469c-A257-4FA25A37C16A}"; ValueType: dword; ValueName: "SaferFlags"; ValueData: "00000000"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()

; Policy Execution Enabler GpgTools -GpgOL_Set_OLK_LoadBehavior-
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{F26F6CE3-606D-4a1c-8649-83A21ADFFDA2}"; ValueType: string; ValueName: "Description"; ValueData: "GpgOL_Set_OLK_LoadBehavior ..."; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{F26F6CE3-606D-4a1c-8649-83A21ADFFDA2}"; ValueType: string; ValueName: "ItemData"; ValueData: "{app}\StartCon\GpgOL_Set_OLK_LoadBehavior.exe"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{F26F6CE3-606D-4a1c-8649-83A21ADFFDA2}"; ValueType: dword; ValueName: "SaferFlags"; ValueData: "00000000"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()

; Policy Execution Enabler GpgTools -GpgOL_Config_InlinePGP-
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{680D4DAB-C292-4e48-99F6-AE5ADCA8D10B}"; ValueType: string; ValueName: "Description"; ValueData: "GpgOL_Config_InlinePGP ..."; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{680D4DAB-C292-4e48-99F6-AE5ADCA8D10B}"; ValueType: string; ValueName: "ItemData"; ValueData: "{app}\StartCon\GpgOL_Config_InlinePGP.exe"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{680D4DAB-C292-4e48-99F6-AE5ADCA8D10B}"; ValueType: dword; ValueName: "SaferFlags"; ValueData: "00000000"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
...
; Policy Execution Enabler EXE-RULE FOR "GpgTools" "reg.exe" USAGE
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{567CE485-7A23-40c8-AF72-A76E06BBB0A6}"; ValueType: string; ValueName: "Description"; ValueData: "GpgTools_reg_exe ..."; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\Safer\CodeIdentifiers\262144\Paths\{{567CE485-7A23-40c8-AF72-A76E06BBB0A6}"; ValueType: expandsz; ValueName: "ItemData"; ValueData: "%SYSTEMDRIVE%\Windows\System32\reg.exe"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: CheckSRPIsEnabled()
...
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\SrpV2\Exe\50188B46-0B3A-4b57-83A3-23ABB57CB843"; ValueType: string; ValueName: "Value"; ValueData: "<FilePathRule Id=""50188B46-0B3A-4b57-83A3-23ABB57CB843"" Name=""GpgTools_GpgOL_Enabe_OLK2016_Resiliency"" Description=""(GpgTools) Allows execution of &quot;Enabe_OLK2016_Resiliency&quot;"" UserOrGroupSid=""S-1-1-0"" Action=""Allow""><Conditions><FilePathCondition Path=""{app}\StartCon\GpgOL_Enabe_OLK2016_Resiliency.exe""/></Conditions></FilePathRule>"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: EnforcementModeEXEActive()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\SrpV2\Exe\DD93F54D-CB4E-4f37-A76D-0254E8FD0806"; ValueType: string; ValueName: "Value"; ValueData: "<FilePathRule Id=""DD93F54D-CB4E-4f37-A76D-0254E8FD0806"" Name=""GpgTools_GpgOL_Set_OLK_LoadBehavior"" Description=""(GpgTools) Allows execution of &quot;Set_OLK_LoadBehavior&quot;"" UserOrGroupSid=""S-1-1-0"" Action=""Allow""><Conditions><FilePathCondition Path=""{app}\StartCon\GpgOL_Set_OLK_LoadBehavior.exe""/></Conditions></FilePathRule>"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: EnforcementModeEXEActive()
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\SrpV2\Exe\E35EC1E7-C3A9-4c90-AF86-103AD864F87C"; ValueType: string; ValueName: "Value"; ValueData: "<FilePathRule Id=""E35EC1E7-C3A9-4c90-AF86-103AD864F87C"" Name=""GpgTools_GpgOL_Config_InlinePGP"" Description=""(GpgTools) Allows execution of &quot;GpgOL_Config_InlinePGP&quot;"" UserOrGroupSid=""S-1-1-0"" Action=""Allow""><Conditions><FilePathCondition Path=""{app}\StartCon\GpgOL_Config_InlinePGP.exe""/></Conditions></FilePathRule>"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: EnforcementModeEXEActive()
...
; APPLOCKER EXE-RULE FOR "GpgTools" "reg.exe" USAGE
Root: "HKLM"; Subkey: "Software\Policies\Microsoft\Windows\SrpV2\Exe\9356E237-DA47-478e-B5AD-86057EC79DD7"; ValueType: string; ValueName: "Value"; ValueData: "<FilePathRule Id=""9356E237-DA47-478e-B5AD-86057EC79DD7"" Name=""GpgTools_reg_exe"" Description=""(GpgTools) Allows execution of &quot;reg.exe&quot;"" UserOrGroupSid=""S-1-1-0"" Action=""Allow""><Conditions><FilePathCondition Path=""%SYSTEM32%\reg.exe""/></Conditions></FilePathRule>"; Flags: uninsdeletekeyifempty uninsdeletevalue; Components: confpatchtoolpol conftoolpol; Check: EnforcementModeEXEActive()
